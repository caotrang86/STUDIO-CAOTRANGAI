...
import { generateEntrepreneurImage, editImageWithPrompt } from '@/src/services/geminiService';
...
const EntrepreneurCreator: React.FC<EntrepreneurCreatorProps> = (props) => {
    ...
    const executeInitialGeneration = async () => {
        ...
        const ideasToUse = appState.selectedIdeas.length > 0 ? appState.selectedIdeas : [t('entrepreneurCreator_randomConcept')];
    ...
    const handleDownloadAll = () => {
        ...
        processAndDownloadAll({
            ...
            videoTasks,
            zipFilename: 'ket-qua-entrepreneur.zip',
            baseOutputFilename: 'entrepreneur',
        });
    };
                    ...
                    <OptionsPanel>
                         <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-6">
                            ...
                            <ActionablePolaroidCard
                                ...
                                caption={t('entrepreneurCreator_styleReferenceCaption')}
                         ...
                         {!appState.styleReferenceImage && (
                             <div className="space-y-2">
                                <label className="base-font font-bold text-lg text-neutral-200">{t('entrepreneurCreator_ideaLabel')}</label>
                                <div className="flex flex-wrap gap-2">
                                    <button 
                                        className={`px-3 py-1 rounded-full text-sm border ${appState.selectedIdeas.includes(t('entrepreneurCreator_randomConcept')) ? 'bg-yellow-400 text-black border-yellow-400' : 'text-neutral-300 border-neutral-600 hover:border-yellow-400'}`}
                                        onClick={() => onStateChange({ ...appState, selectedIdeas: [t('entrepreneurCreator_randomConcept')] })}
                                    >
                        ...
                        <div className="flex items-center justify-end gap-4 pt-4">
                            ...
                            >
                                {isLoading ? t('common_creating') : t('entrepreneurCreator_createButton')}
                            </button>
                        </div>
                    </OptionsPanel>
                )}
