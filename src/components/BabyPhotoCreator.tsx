...
import { generateBabyPhoto, editImageWithPrompt } from '@/src/services/geminiService';
...
const BabyPhotoCreator: React.FC<BabyPhotoCreatorProps> = (props) => {
    ...
    const executeInitialGeneration = async () => {
        ...
        const ideasToUse = appState.selectedIdeas.length > 0 ? appState.selectedIdeas : [t('babyPhotoCreator_randomConcept')];
    ...
    const handleDownloadAll = () => {
        ...
        processAndDownloadAll({
            ...
            videoTasks,
            zipFilename: 'ket-qua-baby.zip',
            baseOutputFilename: 'baby',
        });
    };
                    ...
                    <OptionsPanel>
                         <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-6">
                            ...
                            <ActionablePolaroidCard
                                ...
                                caption={t('babyPhotoCreator_styleReferenceCaption')}
                         ...
                         {!appState.styleReferenceImage && (
                             <div className="space-y-2">
                                <label className="base-font font-bold text-lg text-neutral-200">{t('babyPhotoCreator_ideaLabel')}</label>
                                <div className="flex flex-wrap gap-2">
                                    <button 
                                        className={`px-3 py-1 rounded-full text-sm border ${appState.selectedIdeas.includes(t('babyPhotoCreator_randomConcept')) ? 'bg-yellow-400 text-black border-yellow-400' : 'text-neutral-300 border-neutral-600 hover:border-yellow-400'}`}
                                        onClick={() => onStateChange({ ...appState, selectedIdeas: [t('babyPhotoCreator_randomConcept')] })}
                                    >
                        ...
                        <div className="flex items-center justify-end gap-4 pt-4">
                            ...
                            >
                                {isLoading ? t('common_creating') : t('babyPhotoCreator_createButton')}
                            </button>
                        </div>
                    </OptionsPanel>
                )}
